...
class TestUserExists {
	...
	@Test
	void testUserExists() throws InterruptedException {
    	...
    	String warning = webDriver.findElement(By.xpath("//*[@id=\"post-8\"]/div/div/div[1]/ul/li")).getText(); 
    	assertTrue(warning.contains("Error: An account is already registered with your email address."));
    	Thread.sleep(3000);
